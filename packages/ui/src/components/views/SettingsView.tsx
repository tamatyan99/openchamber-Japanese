    ...
    <div className="h-full overflow-auto">
      <div className="mx-auto w-full max-w-3xl px-6 py-6 space-y-6">
        <div className="space-y-1">
          <h1 className="typography-ui-header font-semibold text-foreground">{t('Settings')}</h1>
          <p className="typography-ui text-muted-foreground">{t('Jump to common pages.')}</p>
        </div>
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          >
            <div className="typography-ui-label text-foreground">{t('Providers')}</div>
            <div className="typography-micro text-muted-foreground/70">{t('Connect models + credentials')}</div>
          </button>
          ...
          >
            <div className="typography-ui-label text-foreground">{t('Agents')}</div>
            <div className="typography-micro text-muted-foreground/70">{t('Prompts, tools, permissions')}</div>
          </button>
          ...
          >
            <div className="typography-ui-label text-foreground">{t('Skills Catalog')}</div>
            <div className="typography-micro text-muted-foreground/70">{t('Install skills from catalogs')}</div>
          </button>
          ...
          >
            <div className="typography-ui-label text-foreground">{t('MCP')}</div>
            <div className="typography-micro text-muted-foreground/70">{t('Configure MCP servers + connections')}</div>
          </button>
          ...
          >
            <div className="typography-ui-label text-foreground">{t('Usage')}</div>
            <div className="typography-micro text-muted-foreground/70">{t('Quota + spend visibility')}</div>
          </button>
        </div>
      </div>
    </div>
    ...
    return (
      <div className="flex h-full items-center justify-center px-6">
        <div className="max-w-md text-center">
          <div className="typography-ui-header font-semibold text-foreground">{t('Not available')}</div>
          <p className="typography-ui text-muted-foreground mt-1">{t('This settings page is not available in this runtime.')}</p>
        </div>
      </div>
    );
  }, []);
                ...
                <Tooltip key={page.slug} delayDuration={collapsed ? 100 : 600}>
                  <TooltipTrigger asChild>
                    ...
                    >
                      ...
                      >
                        <span className="typography-ui-label font-normal truncate">{t(page.title)}</span>
              ...
              <Tooltip delayDuration={300}>
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    <span>{t('Reload OpenCode')}</span>
                  </button>
                </TooltipTrigger>
                <TooltipContent>
                  {t('Restart OpenCode and reload its configuration.')}
                </TooltipContent>
              </Tooltip>
            )}
      ...
      {isMobile ? (
        ...
        >
          <button
            ...
            aria-label={showBackButton ? t('Back to Settings') : t('Close settings')}
          ...
          <div className="min-w-0 flex-1 typography-ui-label font-medium text-foreground truncate">
            {mobileStage === 'nav'
              ? t('Settings')
              : t(activePageMeta?.title ?? 'Settings')}
          </div>
